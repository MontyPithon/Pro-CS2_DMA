...
bool CEntity::IsVisibleTo(int LocalPlayerIndex) const
{
	// Check if this entity is spotted by the local player
	// or if the local player is spotted by this entity
	return (this->Pawn.bSpottedByMask & (DWORD64(1) << LocalPlayerIndex)) != 0;
}